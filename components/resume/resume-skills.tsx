...
const skillItems = [
  ...
  },
  {
    icon: <svg width="40.859" height="15.739" viewBox="0 0 10.811 4.164" xmlns="http://www.w3.org/2000/svg">
      <g fill="#8e2621">
        <path
          d="M3.345 0l-.773 1.34.773 1.339h1.547l.774-1.34L4.892 0zm.183.317h1.18L5.3 1.34l-.59 1.023h-1.18l-.59-1.023zM5.918 1.485l-.774 1.34.774 1.34h1.547l.773-1.34-.773-1.34zm.183.317h1.18l.591 1.023-.59 1.022H6.1l-.59-1.022zM8.49 0l-.773 1.34.773 1.339h1.547l.774-1.34L10.037 0zm.183.317h1.18l.591 1.022-.59 1.023h-1.18l-.59-1.023zM2.32 4.164H.773L0 2.824l.773-1.339H2.32l.774 1.34z"/>
      </g>
    </svg>,
